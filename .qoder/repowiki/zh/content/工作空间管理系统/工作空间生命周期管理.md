...
Client->>Manager : Create(label, colonists, tags, role)
...
participant EventBus as "事件总线"
Source->>Manager : RouteEvents(targetId, events)
...
EventPool->>EventBus : 触发OnThresholdReached事件
...
通过遵循这些最佳实践，可以确保工作空间生命周期管理系统的稳定运行和高效性能。